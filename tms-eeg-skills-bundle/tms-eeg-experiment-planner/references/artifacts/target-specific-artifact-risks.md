---
type: artifact-card
id: target-specific-artifact-risks
title: Target-Specific Artifact Risks
tags:
  - target-risk
  - muscle-artifact
  - sensory-confounds
...
Flag likely artifacts before the target is finalized.
...
Prefer a target/setup with manageable artifacts over a theoretically ideal target that produces uninterpretable EEG.

## Sources

Local good-practice note; DLPFC reliability/mapping cards; i-TEP and lead-configuration cards.
