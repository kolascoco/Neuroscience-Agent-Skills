...
Digest full methods before using specific setup recommendations.

## Practical Recommendations

Ask for or report electrode lead/cable configuration when early responses are analyzed.

## Agent Rules Extracted

Do not interpret early topographies without considering lead configuration.
