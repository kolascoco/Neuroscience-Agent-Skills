...
Digest full paper before extracting specific comparisons.

## Practical Recommendations

Use for pipeline comparison answers and cautions about methodological choices.

## Agent Rules Extracted

Pipeline choices should be justified by artifact profile, target, and analysis goal.
