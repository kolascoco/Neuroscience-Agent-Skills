...
Ask about DLPFC subregion, early local TEP window, ROI, quantification method, and trial count.
...
Do not generalize reliability from one DLPFC target or metric to all prefrontal TMS-EEG.
...
`papers/gogulski-2024-dlpfc-excitability-mapping.md`; `papers/gogulski-2025-dlpfc-methodological-considerations.md`.
